...
public class DispatchServiceTest(TestDataProvider testDataProvider) : IClassFixture<TestDataProvider>
{
    ...
    /// <summary>
    /// ¬ывести все сведени€ о конкретном транспортном средстве.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// ¬ывести всех водителей, совершивших поездки за заданный период, упор€дочить по ‘»ќ.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// ¬ывести суммарное врем€ поездок транспортного средства каждого типа и модели.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// ¬ывести топ 5 водителей по совершенному количеству поездок.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// ¬ывести информацию о количестве поездок, среднем времени и максимальном времени поездки дл€ каждого водител€.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// ¬ывести информацию о транспортных средствах, совершивших максимальное число поездок за указанный период.
    /// </summary>
    [Fact]
